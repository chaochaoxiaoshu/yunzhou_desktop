    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-auto">
        <div className="flex flex-col h-full">
          ...
          <Spacer height={8} />
          <div className="flex flex-col w-[42.125rem] h-full mx-auto">
            ...
            <div className="flex-auto flex items-center">
              ...
              <ProfileActionItem
                icon={downloadsIcon}
                title="多终端下载"
                onClick={() => window.open('http://www.whsdgjzs.com', '__blank')}
              />
              <Spacer width={16} />
              <ProfileActionItem
                icon={aboutIcon}
                title="关于云舟"
                onClick={() => navigate({ to: '/profile/about' })}
              />
            </div>
            <Spacer height={48} />
          </div>
...
function ProfileActionItem(props: ProfileActionItemProps): JSX.Element {
  return (
    <div
      className="flex flex-col items-center py-12 flex-auto cursor-pointer bg-[#0B1327] hover:bg-[#141e35] rounded-lg"
